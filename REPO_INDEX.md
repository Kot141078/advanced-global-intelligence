...
- `official/article50-transparency-implementation-briefs/v0_1/README.md` — Article 50 Transparency Implementation Briefs v0.1, supporting policy-reader and engineering briefs derived from the Article 50 Transparency Submission Pack v0.1; contains an AI Office / policy-reader evidence-chain entry point and an engineering entry point for CGAM, witness events, oracle degradation, human gates, and rollback paths; not legal advice, not certification, not a conformity assessment, and not a formal Article 50 compliance claim.
