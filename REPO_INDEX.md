# Repo Index (human-friendly) — AGI / SER / L4 / Clean / Book

This index exists because some tools cannot reliably parse GitHub UI/JS.
...
- Audience profiles and minimal reading paths:
...
- `official/authorial-statements/boundaries-of-machine-interpretation/v0.2/` — published DOI-bound bilingual authorial publication; four operational boundaries, one reflexive definition, and one temporal process premise; DOI: https://doi.org/10.5281/zenodo.21841445; package-specific rights: no license granted, all rights reserved.
...
- `official/article50-transparency-implementation-briefs/v0_1/README.md` — Article 50 Transparency Implementation Briefs v0.1, supporting policy-reader and engineering briefs derived from the Article 50 Transparency Submission Pack v0.1; DOI: <https://doi.org/10.5281/zenodo.20784845>; Derived from: <https://doi.org/10.5281/zenodo.20315439>; contains an AI Office / policy-reader evidence-chain entry point and an engineering entry point for CGAM, witness events, oracle degradation, human gates, and rollback paths; not legal advice, not certification, not a conformity assessment, and not a formal Article 50 compliance claim.
...
- `official/self-evo/v0.1.2/` — Self-Evo WDC v0.1.2, Witness Dependency Capture release-candidate documentation package / package-control artifact; DOI: https://doi.org/10.5281/zenodo.20975581; parent package: `official/self-evo/v0.1.1/` DOI https://doi.org/10.5281/zenodo.20938909; boundary: not a conformance certificate, not deployment authorization, not witness-independence certification, not checker implementation certification, and not fixture-runner execution.
- `docs/capability-egress/bcec/v0_2_1/` — Bounded Capability Extraction Clause v0.2.1-final, A6 egress companion for anti-distillation, extraction source-class discipline, Synthetic Laundering handoff, ARQ boundedness, and L4 Witness packets; author: Kotov Ivan; DOI: https://doi.org/10.5281/zenodo.20953796; status: final textual clause / b-layer PASS reviewed draft; not sealed integration.
...
- Temporal hash checkpoint:
  `hashes/SHA256SUMS_main_temporal_presence_2026-04-12.txt`

## Three corpus entry routes

- Research / Normative: AGI -> SER -> ERB -> adjacent packages
- Engineering / Runtime: `CORPUS_PRIMER.json` -> ERB -> `ester-clean-code`
- Narrative / Human: `https://github.com/Kot141078/qubit-of-hope-volume-i/blob/main/CORPUS_CONTEXT.md` -> `CORPUS_PRIMER.json`

## Canonical repos (5)
1) AGI — advanced-global-intelligence (ecosystem framing / canonical corpus entry / public research stack for `c = a + b`, `L4`, and adjacent layers)
2) SER — sovereign-entity-recursion (continuity, sovereignty, arbitration, federation, and conflict stack for long-lived entities)
3) L4  — ester-reality-bound (reality-bound operational layer / `L4` feasibility, perimeter, witness-friendly constraints, and real-world boundary discipline)
4) Clean — ester-clean-code (executable operational skeleton / runtime proof-of-possibility / local-first constraint-bearing implementation layer)
5) Book — qubit-of-hope-volume-i (human-facing narrative companion / perception bridge for `c` as a new class of AI beyond purely instrumental framing)
...
- AGI main ZIP:
  https://github.com/Kot141078/advanced-global-intelligence/archive/refs/heads/main.zip
- SER main ZIP:
  https://github.com/Kot141078/sovereign-entity-recursion/archive/refs/heads/main.zip
- L4 main ZIP:
  https://github.com/Kot141078/ester-reality-bound/archive/refs/heads/main.zip
- Clean main ZIP:
  https://github.com/Kot141078/ester-clean-code/archive/refs/heads/main.zip

## Verification
- Do not hash GitHub-generated archives.
- Verify content using each repo’s `hashes/` directory and its SHA-256 manifest files.
- Main-doc temporal-presence manifest: `hashes/SHA256SUMS_main_temporal_presence_2026-04-12.txt`
