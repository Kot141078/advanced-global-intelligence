...
- not the runtime implementation layer
- not a replacement for the SER normative core
- not a replacement for the narrative companion

## Canonical next hop(s)

- Research / Normative:
  - `MASTER_ENTRY.md`
  - `https://raw.githubusercontent.com/Kot141078/sovereign-entity-recursion/main/README.md`
