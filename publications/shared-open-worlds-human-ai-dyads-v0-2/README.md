...
- [Version-specific DOI](https://doi.org/10.5281/zenodo.22542470)
- [All-versions DOI](https://doi.org/10.5281/zenodo.22542469)
- [Zenodo record](https://zenodo.org/records/22542470)
- [Canonical website page](https://ivankotov.eu/publications/shared-open-worlds-human-ai-dyads-v0-2/)
- [English PDF](release/A_C_SHARED_OPEN_WORLD_EXPERIENCE_PAPER_v0_2_EN.pdf)
