...
| A6 | Hybrid or federated anchor | Multi-party, cross-device, cross-entity boundary | Reserved / high-risk | Standing ambiguity, jurisdiction conflict, fork-like drift |
...
## 12. A6 — Hybrid or federated anchor
...
A6 is the highest ambiguity class in this taxonomy.
...
EA custody and disclosure rules
ARL escalation triggers
```

A6 MUST NOT infer unified standing from technical federation.

A6 SHOULD default to compartmentalized continuity, not merged identity.

If standing cannot be mapped, A6 MUST degrade to narrower local classes or deny the operation.
