...
This repository presents AGI as **Advanced Global Intelligence** —
...
- Self-Evo WDC v0.1.2: `official/self-evo/v0.1.2/` | DOI: https://doi.org/10.5281/zenodo.20975581 | status: release-candidate documentation package / package-control artifact; not a conformance certificate; not deployment authorization; not witness-independence certification.
...
- CCDP v0.1 package: `docs/ccdp/` (public package files, technical companions, sensitive-controlled review artifacts)
