...
- `Article 50 Transparency Implementation Briefs v0.1` — supporting policy-reader and engineering briefs derived from the Article 50 Transparency Submission Pack v0.1. Path: `official/article50-transparency-implementation-briefs/v0_1/`; boundary: not legal advice, not certification, not a conformity assessment, not a formal Article 50 compliance claim.
